...
<head>
    ...
    <title>Welcome | FOODPLAZA | FOODMUNCH </title>
...
<body class="d-flex flex-column h-100">
    ...
    for (var)
       <div class="d-flex text-center text-white position-relative promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to UEM Canteen</h1>
            <p class="lead fw-normal"> Online Food Corner</p>
    ...
    <div class="container p-5" id="recommended-shop">
        ...
        ?>
            ...
            <!-- GRID EACH SHOP -->
            <div class="col">
                <a href="<?php echo "shop_menu.php?s_id=".$row["s_id"]?>" class="text-decoration-none text-dark"><!-- echo is used to print any line  -->
