...
<link  href="../img/logo.jpg" rel="stylesheet"  >
...
<body class="d-flex flex-column">
    ...
    <div class="d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-3">
            ...
            <p class="lead fw-normal">CANTEEN MANAGEMENT</p></div>
    </div>

    <div class="container p-5" id="admin-dashboard">
        <h2 class="border-bottom pb-2"><i class="bi bi-graph-up"></i> Canteen Status</h2>
