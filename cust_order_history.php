...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="shop-body">
        <a class="nav nav-item text-decoration-none text-muted mb-3" href="order_success.php" onclick="history.back();">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <button class="nav-link px-4" id="completed-tab" data-bs-toggle="tab" data-bs-target="#nav-completed"
                    type="button" role="tab" aria-controls="nav-completed" aria-selected="true">Completed</button>
            </div>
        </nav>
    ...
    <footer
        ...
        <span class="smaller-font">&copy; The Developer Duo <br /><span class="xsmall-font">Shivam & Swapan</span></span>
